...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2023 at 03:57 AM
...
(2, 'Search-it', 50, 1, 'images/cs03.jpg', 1),
(3, 'Technical-Quiz', 50, 1, 'images/quiz.png', 1),
(4, 'Competitive-Coding', 50, 0, 'images/coding.jpg', 1),
(5, 'Pubg', 50, 0, 'images/pubg.jpg', 2),
(6, 'Counter-Strike', 100, 0, 'images/counter.jpg\r\n', 2),
(7, 'Fashion-Show', 200, 0, 'images/onstage.jpg', 3),
...
(13, 'Mehandi', 100, 1, 'image/mehandi.jpg', 4),
...
INSERT INTO `registered` (`usn`, `name`, `branch`, `sem`, `email`, `phone`, `college`) VALUES
...
INSERT INTO `participent` (`pid`, `usn` , `event_title`) VALUES
(1, '1VA17CS005', 'Search-it'),
(2, '1VA17CS034', 'Technical-Quiz'),
(3, '1VA17IS045', 'Singing'),
(4, '1VA17CS022', 'Mehandi');

--
-- Triggers `participent`
--
DELIMITER $$
CREATE TRIGGER `count` AFTER INSERT ON `participent` FOR EACH ROW update events
set events.participents=events.participents+1
WHERE events.event_title=new.event_title
$$
DELIMITER ;
